<footer class="bg-[#333333] text-white p-10 mt-auto">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 gap-2">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span>info@greenkingdom.com</span>
                </div>
                <div class="flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span>Purwokerto, Banyumas<br/>Jawa Tengah.</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Bottom Section -->
    <div class="mt-8 pt-8 border-t border-gray-600 text-sm">
        <div class="mb-2">
            <a href="#" class="hover:text-gray-300">terms & services</a>
        </div>
        <div class="text-gray-400">
            GreenKingdom @ all right reserved 2024
        </div>
    </div>
</footer>
